/*****************************************************************/
/*  Ice Graphics Drawing Utility                                 */
/*                                                               */
/*  This is a Javascript utility for drawing on the mViewer      */
/*  viewport canvas.  It encapsulates the functionality for      */                                   
/*  loading (drawing) the original image (and subsequent cutout  */
/*  subimages) onto the canvas, drawing the outline of the zoom  */
/*  boxes, and clearing said visual elements when the image is   */
/*  updated.                                                     */
/*****************************************************************/
...
//  Clear both the current image and the 
//  zoom box drawn over it
...
//  Clear only the box drawn over the image

    me.clearDrawing = function()
    {
        clearDrawing();
    }
