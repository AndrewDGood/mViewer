...
/*  - Set the stretch mode (linear, log, log-log, gaussian          */ 
/*    histogram equalization or log-scaled gaussian histogram       */ 
/*    equalization) and range (by value, percentile, or "sigma"     */
/*    value).                                                       */ 
/*  - The selected range is echoed back on the form in all          */
/*    three of the scales above.                                    */
/*                                                                  */
/*  The control works within a div and has to know the mViewer      */
/*  instance that is its parent.                                    */
/*                                                                  */
/*  While this control can be used statically (always up) we have   */
/*  structured it so that it can be deleted and recreated as is a   */
/*  common use mode for pop-ups.  To facilitate this, we cheat a    */
/*  little bit and create a small state object as a child of the    */
/*  parent "viewer".  This is safe so long as the no two controls   */
/*  try to use the same state name (which is unlikely enough that   */
/*  we do not expect it to be an issue).                            */
/*                                                                  */
/*  There is an added complication for this control in that it      */
/*  needs to deal with either a single grayscale/psuedocolor        */
/*  image or three blue/green/red planes in a full-color image.     */
/*  Most of the control is the same, though we need to track the    */
/*  state of the three planes separately in that case and           */
/*  this adds the need for maintaining some state information.      */
/********************************************************************/
...
function ColorStretch(controlDivName, viewer)
{
    ...
    //  The control HTML has a number of sliders, text input
...
//  relationship between data stretch values and percentiles / sigma levels)
    ...
    {
        me.colorTbl = me.viewer.updateJSON.colorTable;
        ...
        if(me.mode == "color")
        {
            ...
            if(me.plane == "blue")
            {
                me.min        = me.viewer.updateJSON.blue_file.min;
                me.max        = me.viewer.updateJSON.blue_file.max;
                me.minpercent = me.viewer.updateJSON.blue_file.min_percent;
                me.maxpercent = me.viewer.updateJSON.blue_file.max_percent;
                me.minsigma   = me.viewer.updateJSON.blue_file.min_sigma;
                me.maxsigma   = me.viewer.updateJSON.blue_file.max_sigma;
                me.datamin    = me.viewer.updateJSON.blue_file.data_min;
                me.datamax    = me.viewer.updateJSON.blue_file.data_max;
            ...
            {
                me.min        = me.viewer.updateJSON.green_file.min;
                me.max        = me.viewer.updateJSON.green_file.max;
                me.minpercent = me.viewer.updateJSON.green_file.min_percent;
                me.maxpercent = me.viewer.updateJSON.green_file.max_percent;
                me.minsigma   = me.viewer.updateJSON.green_file.min_sigma;
                me.maxsigma   = me.viewer.updateJSON.green_file.max_sigma;
                me.datamin    = me.viewer.updateJSON.green_file.data_min;
                me.datamax    = me.viewer.updateJSON.green_file.data_max;
            ...
            {
                me.min        = me.viewer.updateJSON.red_file.min;
                me.max        = me.viewer.updateJSON.red_file.max;
                me.minpercent = me.viewer.updateJSON.red_file.min_percent;
                me.maxpercent = me.viewer.updateJSON.red_file.max_percent;
                me.minsigma   = me.viewer.updateJSON.red_file.min_sigma;
                me.maxsigma   = me.viewer.updateJSON.red_file.max_sigma;
                me.datamin    = me.viewer.updateJSON.red_file.data_min;
                me.datamax    = me.viewer.updateJSON.red_file.data_max;
        ...
        else
        {
            ...
            me.min        = me.viewer.updateJSON.gray_file.min;
            me.max        = me.viewer.updateJSON.gray_file.max;
            me.minpercent = me.viewer.updateJSON.gray_file.min_percent;
            me.maxpercent = me.viewer.updateJSON.gray_file.max_percent;
            me.minsigma   = me.viewer.updateJSON.gray_file.min_sigma;
            me.maxsigma   = me.viewer.updateJSON.gray_file.max_sigma;
            me.datamin    = me.viewer.updateJSON.gray_file.data_min;
            me.datamax    = me.viewer.updateJSON.gray_file.data_max;
        ...
        if(typeof(me.viewer.updateJSON.bunit) == "undefined")
            me.bunit = " ";
        else
    ...
    //  instantiated, so set up the state info.  We do not know 
    //  at this point what details we will be using, so
    //  we will just set up defaults for everything.
...
//  Package up all the stretch info and submit for processing.
    ...
    //  Do not forget to keep a record of the control state since
    //  the user may kill the control at any time.
        ...
        if(me.mode == "grayscale")
        {
            me.viewer.updateJSON.gray_file.color_table  = me.colorTbl;
            me.viewer.updateJSON.gray_file.stretch_mode = me.stretchMode;

            me.viewer.updateJSON.gray_file.stretch_min  = minValue + minUnits;
            me.viewer.updateJSON.gray_file.stretch_max  = maxValue + maxUnits;
        ...
        {
            me.viewer.updateJSON.blue_file.color_table  = me.colorTbl;
            me.viewer.updateJSON.blue_file.stretch_mode = me.stretchMode;

            me.viewer.updateJSON.blue_file.stretch_min  = minValue + minUnits;
            me.viewer.updateJSON.blue_file.stretch_max  = maxValue + maxUnits;
        ...
        {
            me.viewer.updateJSON.green_file.color_table  = me.colorTbl;
            me.viewer.updateJSON.green_file.stretch_mode = me.stretchMode;

            me.viewer.updateJSON.green_file.stretch_min  = minValue + minUnits;
            me.viewer.updateJSON.green_file.stretch_max  = maxValue + maxUnits;
        ...
        {
            me.viewer.updateJSON.red_file.color_table  = me.colorTbl;
            me.viewer.updateJSON.red_file.stretch_mode = me.stretchMode;

            me.viewer.updateJSON.red_file.stretch_min  = minValue + minUnits;
            me.viewer.updateJSON.red_file.stretch_max  = maxValue + maxUnits;
...
//  Build the control div contents.
    ...
    //  Html for color stretch controls
        ...
        + "                <td align='right'><div class='littleLabel'>Stretch:&nbsp;</div></td>"
        + "                <td>"
    ...
    //  Functions for changing adjustable elements
