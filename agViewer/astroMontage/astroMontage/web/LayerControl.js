...
function LayerControl(controlDivName, viewer)
{
   ...
   me.addMarkRec = function(coord_sys, lat, lon, sym_type, sym_size, color, markVisible)
   {
      ...
      row.find(".source").html("<center><input size='40' class='ovInput' value='" + loc + "' /></center>");
      ...
      row.find(".scale").html("<center><input size='8' class='sym_size ovInput' value='" + sym_size + "' /></center>");
